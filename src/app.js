    ...
    origin:
      process.env.NODE_ENV === 'production'
        ...
        : [
            ...
            'http://localhost:5174',
            'http://localhost:5175',
            'https://2301010ba829.ngrok-free.app',
            'https://c3887241310d.ngrok-free.app',
          ],
    credentials: true,
...
// Skip JSON parsing for upload routes to allow multer to handle multipart data
...
// Serve public files (like admin dashboard)
