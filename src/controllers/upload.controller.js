...
const uploadDirs = {
  reviews: path.join(__dirname, '../../uploads/images/reviews'),
  products: path.join(__dirname, '../../uploads/images/products'),
  users: path.join(__dirname, '../../uploads/images/users'),
};
...
const uploadSingle = async (req, res, next) => {
  try {
    ...
    uploadMiddleware(req, res, (err) => {
      ...
      const fileUrl = `/uploads/images/${uploadType}/${req.file.filename}`;
  ...
  try {
    ...
    uploadMiddleware(req, res, (err) => {
      ...
      const files = req.files.map((file) => ({
        ...
        url: `/uploads/images/${uploadType}/${file.filename}`,
        size: file.size,
      }));
