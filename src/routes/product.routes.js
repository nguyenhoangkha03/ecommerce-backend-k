...
// Debug endpoints - uncomment if needed for troubleshooting
// router.get('/:id/debug-recommendations', productController.debugRecommendations);
// router.get('/debug-all', productController.debugAllProducts);
